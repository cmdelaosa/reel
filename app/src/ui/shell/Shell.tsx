        ...
        <div className="mq-top-inner">
          ...
          <div className="mq-top-actions">
            ...
            {/* The panel hangs off this wrapper, not off the window: the bar's
                content sits in a centred column (--bar-max), so a
                viewport-anchored panel drifts further from its own bell the
                wider the screen gets — on the 2752px monitor this was measured
                on, the bell lands near 1960 and the window's edge at 2752, 790px
                apart. Its scrim stays down in Overlays — fixed positioning
                inside the bar would be trapped by the bar's backdrop-filter. */}
