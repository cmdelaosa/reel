...
export default function YouPage() {
  ...
  const links = [
    ...
    { icon: Clapperboard, label: tr("My Movies"), sub: tv("{n} in your library", { n: counts.movie }), path: "/movies/watchlist", show: counts.movie > 0 },
    { icon: Gamepad2, label: tr("My Games"), sub: tv("{n} in your library", { n: counts.game }), path: "/games/backlog", show: counts.game > 0 },
